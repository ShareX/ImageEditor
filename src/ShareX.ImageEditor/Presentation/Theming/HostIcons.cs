...
namespace ShareX.ImageEditor.Presentation.Theming
{
    public static class HostIcons
    {
        ...
        public const string NavigationHistory = LucideIcons.HardDrive;
        public const string NavigationWorkflows = LucideIcons.Combine;
        public const string NavigationUpload = LucideIcons.CloudUpload;
        public const string NavigationTools = LucideIcons.Wand2;
        public const string NavigationSettings = LucideIcons.SlidersVertical;
        ...
        public const string ActionMoveUp = LucideIcons.ChevronUp;
        ...
        public const string StatusWarning = LucideIcons.AlertTriangle;
    }
}
